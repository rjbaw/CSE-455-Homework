...
def rainier_panorama():
    ...
    pan = panorama_image(im1, im2, thresh=3)
    save_image(pan, "output/rainier_panorama_1")
    pan2 = panorama_image(pan, im5, thresh=9)
    save_image(pan2, "output/rainier_panorama_2")
    pan3 = panorama_image(pan2, im6, thresh=3)
    save_image(pan3, "output/rainier_panorama_3")
    pan4 = panorama_image(pan3, im3, thresh=3)
    save_image(pan4, "output/rainier_panorama_4")
    pan5 = panorama_image(pan4, im4, thresh=7)
    save_image(pan5, "output/rainier_panorama_5")
...
def field_panorama():
    ...
    im1 = cylindrical_project(im1, 10000)
    im2 = cylindrical_project(im2, 10000)
    im3 = cylindrical_project(im3, 10000)
    im4 = cylindrical_project(im4, 10000)
    im5 = cylindrical_project(im5, 10000)
    im6 = cylindrical_project(im6, 10000)
    im7 = cylindrical_project(im7, 10000)
    im8 = cylindrical_project(im8, 10000)
    save_image(im1, "output/cylindrical_projection")

    pan = panorama_image(im5, im6, thresh=1, iters=50000, inlier_thresh=2)
    save_image(pan, "output/field_panorama_1")
    pan2 = panorama_image(pan, im7, thresh=10, iters=50000, inlier_thresh=3)
